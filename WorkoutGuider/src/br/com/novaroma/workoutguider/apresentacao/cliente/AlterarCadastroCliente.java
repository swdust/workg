...
public class AlterarCadastroCliente extends JPanel {
	...
	public AlterarCadastroCliente() {
		...
		JLabel lblWorkoutGuider = new JLabel("Alterar cadastro");
		...
		Nome = new JTextField();
		Nome.setText(TelaLogin.c1.getNome());
		...
		Login.setText(TelaLogin.c1.getLogin());
		...
		senhaBox.setText(TelaLogin.c1.getSenha());
		...
		confirmeSenhaBox.setText(TelaLogin.c1.getSenha());
		...
		Endereco.setText(TelaLogin.c1.getEndereco());
		...
		Email.setText(TelaLogin.c1.getEmail());
		...
		Tempo.setText(Integer.toString(TelaLogin.c1.getTempoDisponivel()));
		...
		Idade.setText(Integer.toString(TelaLogin.c1.getIdade()));
		...
		Peso = new JTextField();
		Peso.setText(Double.toString(TelaLogin.c1.getPeso()));
		...
		Altura.setText(Double.toString(TelaLogin.c1.getAltura()));
		...
		Telefone.setText(TelaLogin.c1.getTelefone());
